...
type stackframe = Frame of ((string)*(tuple list)*(string list)*(tuple list))
...
let add sframe name a1 a2 = match name with
                              | "main" -> let frame = Frame ("main", Tup("a", 0)::Tup("b", 0)::[Tup("c", 0)], ["main"], Tup("a", 0)::Tup("b", 0)::[Tup("c", 0)] ) in
                                          frame::sframe
                              | "P" -> let frame = Frame ("P", Tup("x", a1)::Tup("y", a2)::Tup("z", 0)::Tup("a", 0)::Tup("b", 0)::[Tup("c", 0)], "P"::["main"], Tup("x", a1)::Tup("y", a2)::Tup("z", 0)::[Tup("a", 0)] ) in
                                        frame::sframe
                              | "Q" -> let frame = Frame ("Q",Tup("z", a1)::Tup("w", a2)::Tup("x", 0)::Tup("b", 0)::Tup("a", 0)::[Tup("c", 0)], "Q"::["main"], Tup("z", a1)::Tup("w", a2)::Tup("x", 0)::[Tup("b", 0)] ) in
                                       frame::sframe
                              | "R" -> let frame = Frame ("R", Tup("w", a1)::Tup("i", a2)::Tup("j", 0)::Tup("b", 0)::Tup("a", 0)::Tup("c", 0)::Tup("x", 0)::Tup("y", 0)::[Tup("z", 0)], "R"::"P"::["main"], Tup("w", a1)::Tup("i", a2)::Tup("j", 0)::[Tup("b", 0)] ) in
                                       frame::sframe
                              | "S" -> let frame = Frame ("S", Tup("c", a1)::Tup("k", a2)::Tup("m", 0)::Tup("n", 0)::Tup("z", 0)::Tup("a", 0)::Tup("x", 0)::Tup("y", 0)::Tup("b", 0)::[Tup("c", 0)], "S"::"P"::["main"], Tup("c", a1)::Tup("k", a2)::Tup("m", 0)::Tup("n", 0)::[] ) in
                                       frame::sframe
                              | "V" -> let frame = Frame ("V", Tup("m", a1)::Tup("n", a2)::Tup("c", 0)::Tup("j", 0)::Tup("b", 0)::Tup("w", 0)::Tup("i", 0)::Tup("x", 0)::Tup("y", 0)::Tup("z", 0)::[Tup("a", 0)], "V"::"R"::"P"::["main"], Tup("m", a1)::Tup("n", a2)::Tup("c", 0)::Tup("j", 0)::[] ) in
                                       frame::sframe
                              | "T" -> let frame = Frame ("T", Tup("a", a1)::Tup("y", a2)::Tup("i", 0)::Tup("j", 0)::Tup("x", 0)::Tup("b", 0)::Tup("z", 0)::Tup("w", 0)::Tup("a", 0)::[Tup("c", 0)], "T"::"Q"::["main"], Tup("a", a1)::Tup("y", a2)::Tup("i", 0)::Tup("j", 0)::[] ) in
                                       frame::sframe
                              | "W" -> let frame = Frame ("W", Tup("m", a1)::Tup("p", a2)::Tup("j", 0)::Tup("h", 0)::Tup("i", 0)::Tup("j", 0)::Tup("a", 0)::Tup("y", 0)::Tup("x", 0)::Tup("b", 0)::Tup("z", 0)::Tup("w", 0)::[Tup("c", 0)], "W"::"T"::"Q"::["main"], Tup("m", a1)::Tup("p", a2)::Tup("j", 0)::Tup("h", 0)::[] ) in
                                       frame::sframe
                              | "U" -> let frame = Frame ("U", Tup("c", a1)::Tup("z", a2)::Tup("p", 0)::Tup("g", 0)::Tup("x", 0)::Tup("b", 0)::Tup("z", 0)::Tup("w", 0)::Tup("a", 0)::[Tup("c", 0)], "U"::"Q"::["main"], Tup("c", a1)::Tup("z", a2)::Tup("p", 0)::Tup("g", 0)::[] ) in
                                       frame::sframe
...
let rec getFrame s framelist = match framelist with 
                                ...
                                | Frame(name, llist, slist, locallist)::t -> if( name = s ) then Frame(name, llist, slist, locallist) else getFrame s t
...
let rec getvarlist framelist anslist = match framelist with
                                        | [] -> anslist
                                        | Frame(name, llist, slink, locallist)::t -> getvarlist t (app plist (app llist anslist))
