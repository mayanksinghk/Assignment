...
val istype : ((string * exptype) list) -> exptree -> exptype
...
val yield: ((string * exptype) list) -> definition -> ((string * exptype) list) -> ((string * exptype) list)

val tablechange: ((string * exptype) list) -> definition -> ((string * exptype) list) -> ((string * exptype) list)

val tableupdate: ((string * exptype) list) -> definition -> ((string * exptype) list)

val removesamelist: ((string * exptype) list)-> ((string * exptype) list) -> ((string * exptype) list)